...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="me-lg-0">
							<a href="#" data-scrollto="#slider" class="standard-logo" data-dark-logo="{{asset('/assets/images')}}/logo-dark.png"><img src="{{asset('/assets/images')}}/logo.png" alt="Canvas Logo"></a>
							<a href="#" data-scrollto="#slider" class="retina-logo" data-dark-logo="{{asset('/assets/images')}}/logo-dark@2x.png"><img src="{{asset('/assets/images')}}/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container not-dark one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="160">
								...
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-speakers"><div>Speakers</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-schedule"><div>Schedule</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-tickets"><div>Tickets</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-sponsors"><div>Sponsors</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-location"><div>Location</div></a></li>
							</ul>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container header-button">
								<li class="menu-item">
									<a href="#section-tickets" class="button button-effect m-0" data-scrollto="#section-tickets">Buy Tickets</a>
								</li>
							</ul>
		...
		<!-- Hero/Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.8)), url('{{asset('/assets/images')}}/hero-2.jpg') no-repeat center center / cover;">
			...
			<div class="content-wrap pt-0" style="overflow: visible;">
				...
				<div id="section-about" class="section page-section bg-transparent pt-0 clearfix">
					...
					<div class="container clearfix">
						...
						<div class="row justify-content-around dark">
							<div class="col-md-6">
								<h4 class="font-body ls1 text-uppercase">About Meetup</h4>
							...
							<div class="col-md-5">
								<div class="about-img position-relative">
									<div class="my-3 my-lg-0"><div class="gradient-bg"><img src="{{asset('/assets/images')}}/about/2.jpg" alt="About Image"></div></div>
									<div data-0="top: 160px" data-end="top: 120px"><div class="gradient-bg"><img src="{{asset('/assets/images')}}/about/1.jpg" alt="About Image"></div></div>
								</div>
							</div>
						</div>
						...
						<div class="row mx-auto dark"  style="max-width: 1000px;">
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/1.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/2.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/3.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/4.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/5.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Gunther Beard</h4><span>Software Designer</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/6.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Desmond Eagle </h4><span>Canvas Business</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/7.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4 class="gradient-text">Will Barrow</h4><span>Cloud Management</span></div>
								</div>
							...
							<a href="#" class="team col-lg-4 col-sm-6 mb-5">
								<div class="team-image">
									<img src="{{asset('/assets/images')}}/speakers/8.jpg" alt="John Doe">
								</div>
								<div class="team-desc">
							...
							<a href="#" class="team joinspeaker col-lg-4 col-sm-6 mb-5">
								<div class="team-image gradient-bg">
									<img src="{{asset('/assets/images')}}/speakers/blank.jpg" alt="John Doe">
						...
						<div class="schedule-wrap mx-auto rounded" style="max-width: 1000px;">
							<div class="tabs tabs-bb mb-0 clearfix" id="tab-9">
								...
								<ul class="tab-nav d-flex clearfix">
									<li class="flex-fill"><a href="#tabs-1">17th <span class="d-none d-md-inline-block">March</span></a></li>
									<li class="flex-fill"><a href="#tabs-2">18th <span class="d-none d-md-inline-block">March</span></a></li>
									<li class="flex-fill"><a href="#tabs-3">19th <span class="d-none d-md-inline-block">March</span></a></li>
								</ul>
				...
				<div id="section-tickets" class="section page-section bg-transparent pt-0 clearfix">
					...
					<div class="position-relative">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="pricing-box disabled text-center">
										...
										<div class="pricing-action px-5">
											<a href="#" class="button button-large button-gradient w-100 m-0">Buy Ticket</a>
										</div>
									</div>
								</div>
						...
						<div class="dotted-bg" style="background: url('{{asset('/assets/images')}}/dotted-bg.svg') repeat center center / contain; min-height: 75%"></div>
					</div>
				...
				<div id="section-sponsors" class="section page-section bg-transparent pt-0 topmargin-lg clearfix">
					<div class="container">
						...
						<div class="mx-auto schedule-wrap center dark rounded shadow-lg" style="max-width: 1050px; background-color: #000">
							<h4 class="font-body mb-5">Gold Sponsors</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/cnn.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/github.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/google.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/paypal.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/vimeo.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/slack.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Silver Sponsors</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/linkedin.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/nat-geo.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/jetblue.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/zillow.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/amazon.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Partners</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/ps.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/skype.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/jetblue.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="{{asset('/assets/images')}}/sponcors/netflix.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							...
							<a href="#" class="button button-xlarge button-white button-gradient mt-4">Sponsor Us?</a>
						</div>
					</div>
					<div class="dotted-bg" style="background: url('{{asset('/assets/images')}}/dotted-bg.svg') repeat center center / contain; min-height: 25%; top: 90%; right: 0; left: auto; width: 50%"></div>
								...
								<div class="row justify-content-between dark">
									<div class="col-md-4 mb-4">
										...
										<div class="masonry-thumbs grid-container grid-3" data-lightbox="gallery">
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/1.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/1.jpg" alt="Gallery Thumb 1"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/2.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/2.jpg" alt="Gallery Thumb 2"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/3.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/3.jpg" alt="Gallery Thumb 3"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/4.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/4.jpg" alt="Gallery Thumb 4"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/5.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/5.jpg" alt="Gallery Thumb 5"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/6.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/6.jpg" alt="Gallery Thumb 6"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/7.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/7.jpg" alt="Gallery Thumb 7"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/8.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/8.jpg" alt="Gallery Thumb 9"></a>
											<a class="grid-item" href="{{asset('/assets/images')}}/venue/full/9.jpg" data-lightbox="gallery-item"><img src="{{asset('/assets/images')}}/venue/9.jpg" alt="Gallery Thumb 10"></a>
										</div>
									</div>
									...
									<div class="col-md-3 mb-4">
										...
										<div class="d-block">
											...
											<a href="#" class="social-icon si-colored mb-3 si-rounded si-delicious" title="Delicious">
												<i class="icon-delicious"></i>
												<i class="icon-delicious"></i>
											</a>

											<a href="#" class="social-icon si-colored mb-3 si-rounded si-paypal" title="Paypal">
												<i class="icon-paypal"></i>
												<i class="icon-paypal"></i>
											</a>

											<a href="#" class="social-icon si-colored mb-3 si-rounded si-flattr" title="Flattr">
												<i class="icon-flattr"></i>
												<i class="icon-flattr"></i>
											</a>

											<a href="#" class="social-icon si-colored mb-3 si-rounded si-android" title="Android">
												<i class="icon-android"></i>
												<i class="icon-android"></i>
											</a>

											<a href="#" class="social-icon si-colored mb-3 si-rounded si-smashmag" title="Smashmag">
												<i class="icon-smashmag"></i>
												<i class="icon-smashmag"></i>
											</a>

											<a href="#" class="social-icon si-colored mb-3 si-rounded si-gplus" title="Google Plus">
